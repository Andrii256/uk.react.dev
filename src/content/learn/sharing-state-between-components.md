...
Коли пишете компонент, подумайте, яка інформація в ньому має бути контрольованою (за допомогою пропсів), а яка — неконтрольованою (за допомогою стану). Але ви завжди можете передумати і змінити це пізніше.

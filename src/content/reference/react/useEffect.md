...
- **Якщо ви використовуєте [фреймворк](/learn/start-a-new-react-project#full-stack-frameworks), використовуйте його вбудований механізм отримання даних.** Сучасні React-фреймворки мають інтегровані механізми отримання даних, які є ефективними та позбавлені вищезазначених недоліків.
- **В іншому випадку розгляньте можливість використання або створення кешу на стороні клієнта.** Популярні рішення з відкритим кодом включають [React Query](https://tanstack.com/query/latest/), [useSWR](https://swr.vercel.app/) та [React Router 6.4+](https://beta.reactrouter.com/en/main/start/overview). Ви також можете створити власне рішення — у такому випадку ви будете використовувати Effects під капотом, але додатково реалізуєте логіку для дедуплікації запитів, кешування відповідей та уникнення мережевих водоспадів (шляхом попереднього завантаження даних або підняття вимог до даних на рівень маршрутів).

Ви можете продовжувати отримувати дані безпосередньо в Effects, якщо жоден із цих підходів вам не підходить.
